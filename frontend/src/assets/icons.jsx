export function DeleteIcon(props) {
  return (
    <svg className="size-6" {...props} viewBox="0 0 24 24">
      <g strokeWidth="0"></g>
...
export function SunIcon() {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="lucide lucide-sun h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all text-black dark:-rotate-90 dark:scale-0"
    >
...
export function MoonIcon() {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="lucide lucide-moon absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all text-white dark:rotate-0 dark:scale-100"
    >
